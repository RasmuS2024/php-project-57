<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        @lang('auth.password.email.message')
    </div>
    ...
    {{ html()->form('POST', route('password.email'))->open() }}
        ...
        <div>
            {{ html()->label(__('auth.common.email'), 'email')->class('block font-medium text-sm text-gray-700') }}
        ...
        <div class="flex items-center justify-end mt-4">
            {{ html()->button(__('auth.password.email.submit'))
                ->type('submit')
