<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        @csrf
        <div>
            <x-input-label class="block font-medium text-sm text-gray-700" for="email" :value="__('auth.common.email')" />
        ...
        <div class="mt-4">
            <x-input-label class="block font-medium text-sm text-gray-700" for="password" :value="__('auth.common.password')" />
